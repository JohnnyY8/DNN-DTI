...
flags.DEFINE_string("path4SaveEggsFile", "./files",
                    "The path for saving eggs file.")
flags.DEFINE_string("path4Summaries", "./files/summaries",
                    "The path for saving eggs file.")
flags.DEFINE_string("path4SaveModel", "./files/trainedModel",
                    "The path for saving model.")
flags.DEFINE_string("oneCLDataPath4Training", "./files/4_training/PC3",
                    "The path for training in one cell line.")
flags.DEFINE_string("oneCLDataPath4GenerateEggs", "./files/after_merge/PC3",
...
flags.DEFINE_float("threshold4Convegence", 1e-40,
                   "The threshold for training convegence.")

flags.DEFINE_integer("batchSize", 150,
                     "How many samples are trained in each iteration.")
flags.DEFINE_integer("trainEpoches", 1000,
                     "How many times training through all train data.")
flags.DEFINE_integer("nWeight", 10,
